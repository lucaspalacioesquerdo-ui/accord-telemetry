...
export function extractMetrics(rows: Row[], name: string): LogSession {
  ...
  // MAP WOT: max MAP when throttle fully open (approx top 5% of MAP readings)
...
// Baseline historico do Accord
const B: LogSession = {
  name: '', rows: 0, duration_min: null,
